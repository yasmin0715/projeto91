...
function car1_left()
{
    ...
    {
		car1X =car1X - 10;
		console.log("Quando a seta para a esquerda é presionada, x =" + car1X + "/ y =" +car1Y);
        uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1X =car1X + 10;
		console.log("Quanto a seta para a direita é pressionada,  x = " + car1X + "/ y =" +car1Y);
	}
}
function  car2_up()
{
...
function car2_left()
{
	...
	{
		car2X =car2X + 10;
		console.log("Quando a seta para a esquerda é pressionada,  x =" + car2X + "/ y =" +car2X);
	}
}
function car1_right()
{
	...
	{
		car2X =car2X + 10;
		console.log("Quando a seta para a direita é pressionada,  x =" + car2X + "/ y =" +car2X);
	}
}
function my_keydown()
{
